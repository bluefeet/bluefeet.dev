...
const Page = () => <>
  <header className='grid grid-cols-[max-content_max-content] text-white bg-sky-700 dark:bg-zinc-800 place-content-center text-center fixed w-full h-24 md:h-28 lg:h-32 shadow-lg'>
